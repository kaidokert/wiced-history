...
static struct icon icon1 = {
        ...
        .mimetype        = "image/png",
        .resource        = (resource_hnd_t*)&resources_images_DIR_grender_64_png,
...
static struct icon icon2 = {
        ...
        .mimetype        = "image/png",
        .resource        = (resource_hnd_t*)&resources_images_DIR_grender_128_png,
        .resource_buffer = NULL
};
