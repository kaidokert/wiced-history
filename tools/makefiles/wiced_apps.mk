...
define BUILD_OTA2_APPS_RULES
	...
	# we don't use a Factory Reset App (that is for the old-style OTA)
	...
	$(info DCT_IMAGE_SECTOR_ADDRESS := $(DCT_IMAGE_SECTOR_ADDRESS) size:= 4096)
...
# If ota2_download specified, wait for ota2_download to finish before ota2_factory_download starts
...
ota2_factory_download: ota2_factory_image $(OTA2_FACTORY_DOWNLOAD_DEPENDENCY)
