...
wiced_result_t audio_player_audio_render_buffer_release(wiced_audio_render_buf_t *rend_buf, void* session_ptr)
{
    audio_buff_list_t*  buff_ptr;
    audio_player_t*      player = (audio_player_t *)session_ptr;
...
wiced_result_t audio_player_audio_render_buffer_push(audio_player_t* player, audio_decoder_buffer_info_t *buff_info)
{
    ...
    if (wiced_audio_render_push(player->audio_render, &ar_buf) != WICED_SUCCESS)
    {
...
wiced_result_t audio_player_audio_render_deinit(audio_player_t* player)
{
    ...
    {
        wiced_audio_render_deinit(player->audio_render);
...
static wiced_result_t audio_player_start_track(audio_player_t* player)
{
    ...
    params.cb_buf_release = audio_player_audio_render_buffer_release;
    params.cb_time_get    = NULL;
    player->audio_render  = wiced_audio_render_init(&params);
    if (player->audio_render == NULL)
    {
