...
static int audio_client_callback(audio_client_ref handle, void* userdata, AUDIO_CLIENT_EVENT_T event, void* arg)
{
...
static audio_player_t* audio_player_init(void)
{
    ...
    wiced_log_init(WICED_LOG_INFO, audio_player_log_output_handler, NULL);
