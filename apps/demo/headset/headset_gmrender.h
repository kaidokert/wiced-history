...
} headset_gmrender_audio_userdata_t;

 typedef struct
 {
    gmediarender_service_ref           service_handle;
    gmediarender_service_params_t      service_params;
    headset_gmrender_audio_userdata_t  audio_userdata;
 } headset_gmrender_context_t;
