 ...
 *                    Constants
 ******************************************************/
#define HEADSET_MCU_POWERSAVE_DEEPSLEEP      (PLATFORM_MCU_POWERSAVE_MODE_SLEEP)
...
#define HEADSET_WLAN_PM2_RET_ON_HIGH         (20)
#define HEADSET_WLAN_PM2_RET_ON_LOW          (200)

#define HEADSET_AUDIO_VOLUME_MIN             (0)
#define HEADSET_AUDIO_VOLUME_DEFAULT         (36)
#define HEADSET_AUDIO_VOLUME_MAX             (72)
#define HEADSET_AUDIO_NUM_HTTP_BUFFERS       (200)
#define HEADSET_AUDIO_NUM_AUDIO_BUFFERS      (80)
#define HEADSET_AUDIO_SIZE_AUDIO_BUFFERS     (2048)
#define HEADSET_AUDIO_HTTP_THRESHOLD_HIGH    (180)
#define HEADSET_AUDIO_HTTP_THRESHOLD_LOW     (20)
